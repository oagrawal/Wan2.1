#!/bin/bash
# GPU 0: all 3 modes (baseline, adaptive_0.20_0.30, adaptive_0.10_0.30), prompts 0-16
# CUDA_VISIBLE_DEVICES=0 is set in the tmux launch command.

set -e
cd /nfs/oagrawal/wan/Wan2.1

echo "=== [GPU0] Starting wan_dc_baseline (prompts 0-16) ==="
...
echo "=== [GPU0] Starting wan_dc_adaptive_0.20_0.30 (prompts 0-16) ==="
